...
const char* blurh_cs[] =
{
	...
	"#define IMAGE_WIDTH 1000                                                                       \n"
	"                                                                                               \n"
	"shared vec4 pixels[IMAGE_WIDTH];                                                               \n"
	...
	"void main(void)                                                                                \n"
	"{                                                                                              \n"
	"   pixels[gl_GlobalInvocationID.x] = imageLoad(input_image, ivec2(gl_GlobalInvocationID.xy));  \n"
	"                                                                                               \n"
	"   barrier();                                                                                  \n"
	"                                                                                               \n"
...
const char* blurv_cs[] =
{
	...
	"#define IMAGE_HEIGHT 750                                                                       \n"
	"                                                                                               \n"
	"shared vec4 pixels[IMAGE_HEIGHT];                                                              \n"
	...
	"void main(void)                                                                                \n"
	"{                                                                                              \n"
	"   pixels[gl_GlobalInvocationID.y] = imageLoad(input_image, ivec2(gl_GlobalInvocationID.xy));  \n"
	"                                                                                               \n"
	"   barrier();                                                                                  \n"
	"                                                                                               \n"
